      ...
      try {
        ...
        if (goalIsComplete(latestText)) {
          if (completionAuditor) {
            let verdict
            try {
              verdict = await completionAuditor({
            ...
            // The audit is an awaited step: re-check the goal is still active.
          ...
          pushHistory(
            ...
            "completed",
            completionAuditor
              ? "Assistant marked the goal complete; audit approved."
              : "Assistant marked the goal complete.",
          )
